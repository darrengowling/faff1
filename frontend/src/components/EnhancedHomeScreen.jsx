 ...
 * Improved in-app home with page menu dropdown, quick actions, and league switching
 */
...
import { 
  ...
  Calendar, DollarSign, Target, Crown, LogOut, User
} from 'lucide-react';
            ...
            <Card>
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    <CardTitle className="text-lg">{selectedLeague.name}</CardTitle>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">{selectedLeague.member_count}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 flex items-center">
                    ...
                    <span className="font-medium">{selectedLeague.settings?.budget_per_manager || 'N/A'} credits</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 flex items-center">
                    ...
                    <span className="font-medium">{selectedLeague.settings?.club_slots_per_manager || 'N/A'}</span>
                  </div>
                </div>
              ...
              {leagues.map((league) => (
                <Card 
                  ...
                  className={`hover:shadow-lg transition-shadow cursor-pointer ${
                    selectedLeague?.id === league.id ? 'ring-2 ring-blue-500 bg-blue-25' : ''
                  }`}
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">{league.settings?.budget_per_manager || 'N/A'} credits</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600 flex items-center">
                          <Target className="w-3 h-3 mr-1" />
                        ...
                        <span className="font-medium">{league.settings?.club_slots_per_manager || 'N/A'}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
