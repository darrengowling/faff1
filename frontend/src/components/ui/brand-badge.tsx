...
export const BrandBadge: React.FC<BrandBadgeProps> = ({
  ...
  // Brand icon (using Trophy as placeholder - can be replaced with actual logo)
  const BrandIcon = () => (
...
export const HeaderBrand: React.FC<{ onClick?: () => void; className?: string }> = ({ 
  onClick, 
  className 
}) => (
  <BrandBadge 
...
export const FooterBrand: React.FC<{ className?: string }> = ({ className }) => (
  <BrandBadge 
    variant="full" 
    size="sm" 
    showTagline={true}
...
export const AuthBrand: React.FC<{ className?: string }> = ({ className }) => (
  <BrandBadge 
    variant="full" 
    size="lg" 
    showTagline={true}
...
export const CompactBrand: React.FC<{ className?: string }> = ({ className }) => (
  <BrandBadge 
    variant="compact" 
    size="md"
    className={className}
