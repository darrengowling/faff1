...
const MarketingShell = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-theme-surface flex flex-col">
      ...
      <header 
        className="sticky top-0 w-full bg-theme-surface/90 backdrop-blur-sm border-b border-theme-surface-border z-30"
        ...
        >
                <div className="p-4">
                  ...
                  <div className="py-4">
                    ...
                    <div className="mb-4">
                      {/* Mobile drawer variant testid for marketing shell */}
                      <BackToHomeLink 
