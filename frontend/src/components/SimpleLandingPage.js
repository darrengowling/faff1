...
const SimpleLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-theme-surface">
      ...
      {/* Hero Section */}
      <TestableSection id="home" className="anchor-section pt-16 bg-gradient-to-br from-blue-50 via-theme-surface to-indigo-50 min-h-screen flex items-center" data-testid={TESTIDS.sectionHome}>
      ...
      <TestableSection id="how" className="anchor-section py-20 bg-theme-surface" data-testid={TESTIDS.sectionHow}>
      ...
      {/* Features Section */}
      <TestableSection id="features" className="anchor-section py-20 bg-theme-surface" data-testid={TESTIDS.sectionFeatures}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
      ...
      <TestableSection id="safety" className="anchor-section py-20 bg-blue-50" data-testid={TESTIDS.sectionSafety}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
      ...
      {/* FAQ Section */}
      <TestableSection id="faq" className="anchor-section py-20 bg-gray-50" data-testid={TESTIDS.sectionFaq}>
