...
test.describe('Landing Page - Comprehensive Testing', () => {
  ...
  test('Landing page loads correctly with all sections', async ({ page }) => {
    try {
      ...
      const createLeagueBtn = byId(page, 'landingCtaCreate');
      const joinInviteBtn = byId(page, 'landingCtaJoin');
  ...
  test('CTAs route to create/join flows correctly', async ({ page }) => {
    try {
      ...
      const createLeagueBtn = byId(page, 'landingCtaCreate').first();
      const joinInviteBtn = byId(page, 'landingCtaJoin').first();
