...
const BACKEND_URL = process.env.REACT_APP_BACKEND_URL || 'https://e2e-stability.preview.emergentagent.com';
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://e2e-stability.preview.emergentagent.com';
