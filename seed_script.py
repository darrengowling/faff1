...
class UCLAuctionSeeder:
    ...
    async def generate_summary(self):
        ...
        logger.info("   - Login: https://ucl-manager-hub.preview.emergentagent.com")
        logger.info(f"   - League: https://ucl-manager-hub.preview.emergentagent.com/dashboard")
        logger.info("=" * 60)
