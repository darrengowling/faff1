...
class UCLAuctionSeeder:
    ...
    async def generate_summary(self):
        ...
        logger.info("   - Login: https://champion-bid-portal.preview.emergentagent.com")
        logger.info(f"   - League: https://champion-bid-portal.preview.emergentagent.com/dashboard")
        logger.info("=" * 60)
