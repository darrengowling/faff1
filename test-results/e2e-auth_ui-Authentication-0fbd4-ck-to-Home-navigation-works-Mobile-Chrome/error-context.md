      ...
      - banner [ref=e4]:
        - generic [ref=e6]:
          ...
          - button "Toggle navigation menu" [ref=e18] [cursor=pointer]:
            - img
        - generic [ref=e19]: "Mobile drawer state: closed"
      - main [ref=e20]:
        - generic [ref=e22]:
          - generic [ref=e23]:
            - img [ref=e24]
          ...
          - paragraph [ref=e38]: No password required. We'll send you a secure link to sign in.
  - link "Emergent platform logo Made with Emergent" [ref=e39] [cursor=pointer]:
    - /url: https://app.emergent.sh/?utm_source=emergent-badge
    - generic [ref=e40] [cursor=pointer]:
      - img "Emergent platform logo" [ref=e41] [cursor=pointer]
      - paragraph [ref=e42] [cursor=pointer]: Made with Emergent
```