...
- generic [active]:
  ...
  - iframe [ref=e5]:
    - generic [ref=f1e2]:
      ...
      - generic [ref=f1e6]:
        - generic [ref=f1e7] [cursor=pointer]: ERROR in ./src/components/LoginPage.jsx 17:0-46
        - generic [ref=f1e8]: "Module not found: Error: Can't resolve './BackToHomeLink' in '/app/frontend/src/components'"
```