...
- generic [active]:
  ...
  - iframe [ref=e5]:
    - generic [ref=f1e2]:
      ...
      - generic [ref=f1e6]:
        - generic [ref=f1e7] [cursor=pointer]: ERROR in ./src/components/LoginPage.jsx 14:0-54
        - generic [ref=f1e8]: "Module not found: Error: Can't resolve '../utils/safeBrowser' in '/app/frontend/src/components'"
```