...
MAX_RETRIES=3
TIMEOUT=30
BASE_URL="${PLAYWRIGHT_BASE_URL:-https://magic-league.preview.emergentagent.com}"
...
(async () => {
  ...
  try {
    const baseUrl = process.env.BASE_URL || "https://magic-league.preview.emergentagent.com";
