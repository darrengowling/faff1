...
if TEST_MODE:
    ...
    cors_origins.extend(["http://localhost:3000", "https://test-harmony.preview.emergentagent.com"])
    # Remove duplicates
...
async def request_magic_link(request: MagicLinkRequest):
    ...
    try:
        ...
        if is_development or TEST_MODE:
            frontend_url = os.getenv("FRONTEND_URL", "https://test-harmony.preview.emergentagent.com")
